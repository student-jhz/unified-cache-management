...
- **Add support for new hardware or components**  
...
Open the site in your browser before submitting a pull request.

- English version: [http://127.0.0.1:8000/](http://127.0.0.1:8000/)
- Chinese version: [http://127.0.0.1:8000/zh/](http://127.0.0.1:8000/zh/)
