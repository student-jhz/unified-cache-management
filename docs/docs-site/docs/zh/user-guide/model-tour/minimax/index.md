...
vLLM Ascend 已发布的 MiniMax 模型教程。

## 模型

| 模型 | vLLM Ascend latest 指南 |
| --- | --- |
| MiniMax-M2 | [官方指南](https://docs.vllm.ai/projects/ascend/en/latest/tutorials/models/MiniMax-M2.html) |
| MiniMax-M3 | [官方指南](https://docs.vllm.ai/projects/ascend/en/latest/tutorials/models/MiniMax-M3.html) |
